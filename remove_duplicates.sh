...
echo nohup java -Xmx4g -Dsnappy.disable=true -jar ${PICARD}/SortSam.jar I=$DIR/${BASE_NAME}_trimmed_1and2.bam O=${DIR}/${BASE_NAME}.picsort.bam SO=coordinate VALIDATION_STRINGENCY=SILENT  >> ${DIR}/${BASE_NAME}.log 

nohup java -Xmx4g -Dsnappy.disable=true -jar ${PICARD}/SortSam.jar I=$DIR/${BASE_NAME}_trimmed_1and2.bam O=${DIR}/${BASE_NAME}.picsort.bam SO=coordinate VALIDATION_STRINGENCY=SILENT &
